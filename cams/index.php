		...
		<div class="container py-md-3">
			...
			<div class="calltoaction-20-content row">
				<div class="column center-align-self col-lg-6 pr-lg-5">
					<h3 class="editContent"><b>Welcome To Our Campus<b></h3>
                    <?php
...
?>
					<H2>A Website for College Admission.</H2>
						<?php } ?>
			...
			<div class="grid grid-column-2 ">
				...
				<div class="column1">
					<div class="heading">
						...
						<p class="my-3 text-white"> The College provide different Varietys of Courses.</p>
					  </div>
					</div>
					<div class="column2">
